...
def genetic_algorithm(
    ...
    while yield_rate < DESTINED_YIELD_RATE and gen_counter < MAX_GENERATION:
        ...
        selected_chromosome: List[Dict[str, List[float]|List[int]|Any]] = selection(population=modified_population)

        childs: List[Dict[str, List[float]|List[int]|Any]] = crossover(selected_chromosome)

        population = selected_chromosome.copy() + childs.copy()
